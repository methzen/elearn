...
function AuthenticateDialog({open, cancel}: any) {
    ...
    return (
        ...
        <Stack direction="row" spacing={0.5}>
          ...
          <Link underline="always" variant="subtitle2" onClick={()=>setRegister(false)} sx={{cursor: 'pointer'}}>
            Sign in
          </Link>
        </Stack>
      </Stack>
    ...
    <Stack spacing={2} sx={{ mb: 5, position: 'relative' }}>
        ...
        <Stack direction="row" spacing={0.5}>
          ...
          <Link underline="always" variant="subtitle2" onClick={()=>setRegister(true)} sx={{cursor: 'pointer'}}>
            Create an account
          </Link>
        </Stack>
      </Stack>
...
function About() {
  ...
  const [selectedPrice, setSelectedPrice] = useState<Price|null>(plans.length>0 ?plans[0]: null)
